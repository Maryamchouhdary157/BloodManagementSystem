<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Edit Profile.aspx.cs" Inherits="MyProfile" %>
            ...
            <div class="row contact-form pt-lg-5">
                ...
                <div class="col-lg-8 wthree-form-left px-lg-5 mt-lg-0 mt-5">
                    ...
                    <div class="contact-top1">
                        <h5 class="sub-title-wthree">Edit Profile</h5>
                        <form action="#" method="get" class="pc-contact">
                            ...
                            <asp:Button ID="btnupdate" runat="server" class="btn btn-primary btn-block w-25" Text="Update" />
                        </form>
                    </div>
