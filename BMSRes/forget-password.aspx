<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="forget-password.aspx.cs" Inherits="forget_password_" %>
            ...
            <div class="row contact-form pt-lg-5">
                ...
                <div class="col-lg-8 wthree-form-left px-lg-5 mt-lg-0 mt-5">
                    ...
                    <div class="contact-top1">
                        <h5 class="sub-title-wthree">Forget Password Form</h5>
                        <form action="#" method="get" class="pc-contact">
                            ...
                            <div class="form-group">
                                <label for="contact-new-Passward"> New Passward
                                    <span>*</span>
                                </label>
                            ...
                            <asp:Button ID="btnforgetpassword" runat="server" class="btn btn-primary btn-block w-25" Text="Confirm Passward" />
                        </form>
                    </div>
