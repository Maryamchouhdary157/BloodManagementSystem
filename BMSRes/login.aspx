                ...
                <div class="col-lg-8 wthree-form-left px-lg-5 mt-lg-0 mt-5">
                    ...
                    <div class="contact-top1">
                        ...
                        <form action="#" method="get" class="pc-contact">
                            ...
                            <div class="form-group">
                                <asp:Button ID="btnLogIn" runat="server" class="btn btn-primary btn-block w-25" Text="LogIn" OnClick="btnLogIn_Click" />
                                </div>

                            <div class="form-group">
                               <asp:HyperLink ID="lnkforgetpassward" runat="server" class="btn btn-primary btn-block w-25" Text="ForgetPassward" CausesValidation="False" NavigateUrl="forget-password.aspx" />
                                </div>
