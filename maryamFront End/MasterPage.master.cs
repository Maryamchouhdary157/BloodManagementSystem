...
public partial class MasterPage : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["CurrentUser_ID"] != null)
        {
            ...
            if (Convert.ToBoolean(UserRole.Contains("Donor"))== true)
            { mnuConfirmation.Visible = true;  mnumybloodrequested.Visible = true; mnuSearchDonor.Visible = false; }
            else { mnuSearchDonor.Visible = true; } 
